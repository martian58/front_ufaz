...
class User(db.Model, UserMixin):
    ...
    last_updated = db.Column(db.DateTime, default=datetime.datetime.now(datetime.UTC))
    last_login = db.Column(db.DateTime, default=datetime.datetime.now(datetime.UTC))
...
def save_score():
    ...
    if average_score:
        ...
        average_score.updated_at = datetime.datetime.now(datetime.UTC)
        db.session.commit()
